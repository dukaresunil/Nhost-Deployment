export interface Typegen0 {
    ...
    eventsCausingActions: {
        ...
        reportSignedOut: 'SIGNOUT' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.passwordlessEmail' | 'done.invoke.passwordlessSms' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey' | 'error.platform.authenticateAnonymously' | 'error.platform.authenticateUserWithPassword' | 'error.platform.authenticateUserWithSecurityKey' | 'error.platform.authenticateWithToken' | 'error.platform.importRefreshToken' | 'error.platform.signInMfaTotp';
    ...
    eventsCausingGuards: {
        ...
        hasRefreshToken: '';
        hasSession: 'SESSION_UPDATE' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey';
