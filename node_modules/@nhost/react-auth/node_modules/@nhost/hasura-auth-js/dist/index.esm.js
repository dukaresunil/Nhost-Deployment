...
import { AuthClient, signUpEmailSecurityKeyPromise, signUpEmailPasswordPromise, signInAnonymousPromise, encodeQueryParameters, rewriteRedirectTo, signInEmailPasswordPromise, EMAIL_NEEDS_VERIFICATION, signInEmailSecurityKeyPromise, signInEmailPasswordlessPromise, signInSmsPasswordlessOtpPromise, signInSmsPasswordlessPromise, signInMfaTotpPromise, INVALID_SIGN_IN_METHOD, signOutPromise, createResetPasswordMachine, resetPasswordPromise, createChangePasswordMachine, changePasswordPromise, createSendVerificationEmailMachine, sendVerificationEmailPromise, createChangeEmailMachine, changeEmailPromise, addSecurityKeyPromise, NO_REFRESH_TOKEN, TOKEN_REFRESHER_RUNNING_ERROR, INVALID_REFRESH_TOKEN } from "@nhost/core";
...
class HasuraAuthClient {
  ...
  getAuthenticationStatus() {
    var _a;
    const connectionAttempts = ((_a = this.client.interpreter) == null ? void 0 : _a.getSnapshot().context.importTokenAttempts) || 0;
    if (!this.isReady()) {
      return {
